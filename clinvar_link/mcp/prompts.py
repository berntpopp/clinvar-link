...
def register_workflow_prompts(mcp: FastMCP) -> None:
    ...
    def variant_classification_workflow(
        ...
        return (
            ...
            "clinical_significance (classification), review_status, and gold_stars "
            "(0-4 star rating).\n"
            ...
            "4. Cite the vcv_id and the clinvar_release / clinvar_release_date from "
            "_meta. Canonical source: ClinVar (NCBI). "
    ...
    def gene_clinvar_landscape_workflow(
        ...
        return (
            ...
            "get_variant(identifier='<vcv_id>') for the full record.\n"
            "4. Cite the gene symbol, the relevant vcv_ids, and the clinvar_release / "
            "clinvar_release_date from _meta. Canonical source: ClinVar (NCBI). "
            "https://www.ncbi.nlm.nih.gov/clinvar/.\n"
